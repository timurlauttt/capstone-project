...
<section class="pt-10 pb-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-4xl font-bold text-gray-800 mb-3">Koleksi Bibit Bunga</h2>
            <p class="text-gray-600 text-lg">Temukan berbagai bibit bunga cantik untuk memperindah taman rumahmu.</p>
        </div>
