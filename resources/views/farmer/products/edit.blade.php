    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center space-x-3 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Edit Bibit</h1>
            </div>
            <p class="text-gray-600 ml-9">Update informasi bibit {{ $product->title }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <form action="{{ route('farmer.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="unit" 
                                value="{{ old('unit', $product->unit ?? 'batang') }}"
                ...
                <div class="mb-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="relative group">
                            <img src="{{ asset($img->path) }}" class="w-full h-32 object-cover rounded-lg">
                            <label class="absolute top-2 right-2 bg-white rounded-lg px-2 py-1 shadow-lg cursor-pointer hover:bg-red-50 transition">
                ...
                <!-- Upload Gambar Baru -->
                <div class="mb-6 pt-6 border-t border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Tambah Foto Baru</h2>
