<footer class="bg-[#004f00] text-white">
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">

            {{-- Company Info --}}
            <div class="space-y-3 md:space-y-4">
                <div class="font-bold pb-2">Kontak Kami</div>
                {{-- Social Media --}}
                <div class="flex flex-col space-y-3 md:space-y-4">
                    {{-- WhatsApp --}}
                    <a href="https://wa.me/6288216178244" target="_blank"
                        ...
                        <span class="break-words">+62 882-1617-8244</span>
                    </a>
                    {{-- Instagram --}}
            ...
            {{-- Menu --}}
            <div class="space-y-3 md:space-y-4">
                <h3 class="font-semibold text-lg pb-2">Menu</h3>
                <div class="flex flex-col space-y-3 md:space-y-4">
                    <a href="/" target="_blank"
                        class="text-gray-200 text-sm hover:text-green-400 transition flex items-center gap-2">
                        <span>Beranda</span>
                    </a>
                    <a href="#produkSection" target="_self"
                        class="text-gray-200 text-sm hover:text-green-400 transition flex items-center gap-2">
                        <span>Bibit Unggul</span>
                    </a>
                    <a href="#tentangSection" target="_self"
                        class="text-gray-200 text-sm hover:text-green-400 transition flex items-center gap-2">
                        <span>Tentang</span>
                    </a>
                </div>
            ...
            {{-- Alamat --}}
            <div class="space-y-3 md:space-y-4">
                <h3 class="font-semibold text-lg pb-2">Alamat</h3>
                <div class="flex flex-col space-y-3 md:space-y-4">
