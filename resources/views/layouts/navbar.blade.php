<nav class="bg-white border-b">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="hidden md:flex md:items-center md:space-x-4">
                    <a href="#" class="text-black px-3 py-2 rounded-md hover:bg-gray-100">Beranda</a>
                    <a href="#" class="text-black px-3 py-2 rounded-md hover:bg-gray-100">Produk Unggulan</a>
                    <a href="#" class="text-black px-3 py-2 rounded-md hover:bg-gray-100">Lorem Ipsum 1</a>
                    <a href="#" class="text-black px-3 py-2 rounded-md hover:bg-gray-100">Lorem Ipsum 2</a>
                </div>
    ...
    <div id="mobile-menu" class="md:hidden hidden border-t">
        <div class="px-4 pt-4 pb-3 space-y-1">
            <a href="#" class="block text-gray-700 px-3 py-2 rounded-md">Beranda</a>
            <a href="#" class="block text-gray-700 px-3 py-2 rounded-md">Produk Unggulan</a>
            <a href="#" class="block text-gray-700 px-3 py-2 rounded-md">Lorem Ipsum 1</a>
            <a href="#" class="block text-gray-700 px-3 py-2 rounded-md">Lorem Ipsum 2</a>
        </div>
    </div>
